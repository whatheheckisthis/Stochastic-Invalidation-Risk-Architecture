...
|---|---|---|---|
| 1.1 | Model scope is declared and non-goals are explicit | [`notebooks/sira_non_goals_table.md`](sira_non_goals_table.md) | Non-goals register (NG-001 to NG-024) |
| 1.2 | Notebook is read-only — does not write to `output/` | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) §What SIRA is | Cell 12 session metadata |
| 1.3 | Notebook is not a replacement for `run_all.R` | [`SIRA_READER_GUIDE.md`](SIRA_READER_GUIDE.md) | [`sira_non_goals_table.md`](sira_non_goals_table.md) section |
...
| 2.3 | Gaussian ruled out on structural grounds | [`SIRA_RNORM_RATIONALE.md`](SIRA_RNORM_RATIONALE.md) | Cell 08 log-scale chart |
| 2.4 | Gaussian reference draw is comparison only, not signal input | [`SIRA_RNORM_RATIONALE.md`](SIRA_RNORM_RATIONALE.md) | Cell 04 annotation |
...
| 3.2 | WATCH exclusion from core engine is documented | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) §Why the signal is binary | [`sira_non_goals_table.md`](sira_non_goals_table.md) |
| 3.3 | WATCH validity in spread layer is justified | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) §Why the signal is binary | [`sira_non_goals_table.md`](sira_non_goals_table.md) |
...
| # | Criterion | Where to verify | Evidence artefact |
|---|---|---|---|
| 4.1 | Liability engine is not actuarial valuation | `SIRA_ASSUMPTIONS.md §2.1` | [`sira_non_goals_table.md`](sira_non_goals_table.md) |
| 4.2 | LGD proxy construction is correctly attributed | `SIRA_ASSUMPTIONS.md §2.2` | `CREDIT_RISK_LAYER.md §1.1` |
| 4.3 | Spread signal graduated response path exists | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) §Why the capital stack layer exists | `RISK_COMMITTEE.md` |
...
| # | Criterion | Where to verify | Evidence artefact |
|---|---|---|---|
| 5.1 | DCF outputs are not MtM valuations | `SIRA_ASSUMPTIONS.md §3.1` | [`sira_non_goals_table.md`](sira_non_goals_table.md) |
| 5.2 | IRR outputs are not audited return attestations | `SIRA_ASSUMPTIONS.md §3.2` | [`sira_non_goals_table.md`](sira_non_goals_table.md) |
| 5.3 | M&A signals are not investment advice | [`sira_non_goals_table.md`](sira_non_goals_table.md) | Non-goals register |
...
| 6.3 | Firm value V is operator-declared, not market-calibrated | `SIRA_ASSUMPTIONS.md §4.1` | [`sira_non_goals_table.md`](sira_non_goals_table.md) |
| 6.4 | Vol surface is scenario-governed, not market-implied | `SIRA_ASSUMPTIONS.md §4.1` | [`sira_non_goals_table.md`](sira_non_goals_table.md) |
| 6.5 | Merton linkage is explanatory framing only | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) §Why BSM is included | [`sira_non_goals_table.md`](sira_non_goals_table.md) |
| 6.6 | BSM/SIRA convergence diagnostic is interpreted correctly | `SIRA_ASSUMPTIONS.md §4.1` | Cell 18 convergence column |
| 6.7 | Leverage effect amplification mechanism is documented | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) §Why BSM is included | Cell 18 annotation |
| 6.8 | Greeks are BSM/GBM only — stochastic vol not implemented | `SIRA_ASSUMPTIONS.md §4.1` | [`sira_non_goals_table.md`](sira_non_goals_table.md) |
...
| 7.2 | Path resolver finds correct config | [`SIRA_PATH_RESOLVER.md`](SIRA_PATH_RESOLVER.md) | Cell 12 config source log |
...
| 7.5 | Re-run from Cell 02 produces identical outputs | [`SIRA_PATH_RESOLVER.md`](SIRA_PATH_RESOLVER.md) | Determinism by construction |
...
| O8 | Confirm firm value V declaration and governance | [`sira_non_goals_table.md`](sira_non_goals_table.md) |
| O9 | Define audit log retention schedule | [`SIRA_PATH_RESOLVER.md`](SIRA_PATH_RESOLVER.md) |
