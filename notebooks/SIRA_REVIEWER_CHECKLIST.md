...
| 1.3 | Notebook is not a replacement for `run_all.R` | [`SIRA_READER_GUIDE.md`](SIRA_READER_GUIDE.md) | `README.md NG` section |
...
| 3.2 | WATCH exclusion from core engine is documented | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) §Why the signal is binary | `README.md NG-002` |
| 3.3 | WATCH validity in spread layer is justified | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) §Why the signal is binary | `README.md NG-002` |
...
| 6.5 | Merton linkage is explanatory framing only | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) §Why BSM is included | `README.md NG-018` |
