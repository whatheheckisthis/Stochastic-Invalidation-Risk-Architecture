...
|---|---|---|---|
| 1.1 | Model scope is declared and non-goals are explicit | [`SIRA_NON_GOALS.md`](SIRA_NON_GOALS.md) | Non-goals register (NG-001 to NG-024) |
...
| 1.3 | Notebook is not a replacement for `run_all.R` | [`README.md`](README.md) | [`SIRA_NON_GOALS.md`](SIRA_NON_GOALS.md) section |
...
| 2.3 | Gaussian ruled out on structural grounds | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) | Cell 08 log-scale chart |
| 2.4 | Gaussian reference draw is comparison only, not signal input | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) | Cell 04 annotation |
...
| 3.2 | WATCH exclusion from core engine is documented | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) §Why the signal is binary | [`SIRA_NON_GOALS.md`](SIRA_NON_GOALS.md) |
| 3.3 | WATCH validity in spread layer is justified | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) §Why the signal is binary | [`SIRA_NON_GOALS.md`](SIRA_NON_GOALS.md) |
...
| # | Criterion | Where to verify | Evidence artefact |
|---|---|---|---|
| 4.1 | Liability engine is not actuarial valuation | `SIRA_ASSUMPTIONS.md §2.1` | [`SIRA_NON_GOALS.md`](SIRA_NON_GOALS.md) |
...
| # | Criterion | Where to verify | Evidence artefact |
|---|---|---|---|
| 5.1 | DCF outputs are not MtM valuations | `SIRA_ASSUMPTIONS.md §3.1` | [`SIRA_NON_GOALS.md`](SIRA_NON_GOALS.md) |
| 5.2 | IRR outputs are not audited return attestations | `SIRA_ASSUMPTIONS.md §3.2` | [`SIRA_NON_GOALS.md`](SIRA_NON_GOALS.md) |
| 5.3 | M&A signals are not investment advice | [`SIRA_NON_GOALS.md`](SIRA_NON_GOALS.md) | Non-goals register |
...
| 6.3 | Firm value V is operator-declared, not market-calibrated | `SIRA_ASSUMPTIONS.md §4.1` | [`SIRA_NON_GOALS.md`](SIRA_NON_GOALS.md) |
| 6.4 | Vol surface is scenario-governed, not market-implied | `SIRA_ASSUMPTIONS.md §4.1` | [`SIRA_NON_GOALS.md`](SIRA_NON_GOALS.md) |
| 6.5 | Merton linkage is explanatory framing only | [`SIRA_METHODOLOGY.md`](SIRA_METHODOLOGY.md) §Why BSM is included | [`SIRA_NON_GOALS.md`](SIRA_NON_GOALS.md) |
...
| 6.8 | Greeks are BSM/GBM only — stochastic vol not implemented | `SIRA_ASSUMPTIONS.md §4.1` | [`SIRA_NON_GOALS.md`](SIRA_NON_GOALS.md) |
...
| 7.2 | Path resolver finds correct config | [`ARCHITECTURE_APPENDIX_PATH_RESOLUTION.md`](ARCHITECTURE_APPENDIX_PATH_RESOLUTION.md) | Cell 12 config source log |
...
| 7.5 | Re-run from Cell 02 produces identical outputs | [`ARCHITECTURE_APPENDIX_PATH_RESOLUTION.md`](ARCHITECTURE_APPENDIX_PATH_RESOLUTION.md) | Determinism by construction |
...
| O8 | Confirm firm value V declaration and governance | [`SIRA_NON_GOALS.md`](SIRA_NON_GOALS.md) |
| O9 | Define audit log retention schedule | [`ARCHITECTURE_APPENDIX_PATH_RESOLUTION.md`](ARCHITECTURE_APPENDIX_PATH_RESOLUTION.md) |
